(function ($) {
    ...
    /*-----------------------------------------------------------------------------------
        Template Name: DamarisyDental
        Author: RRDevs
        Support: https://support.rrdevs.net
        Description: DamarisyDental.
        Version: 1.0
   ...
   ========================================*/
    ...
    /* image compare js ***/
    function initializeDraggable(containerSelector) {
        var ctrl = jQuery(containerSelector + ' .comparison-ctrl');
        var pic_right = jQuery(containerSelector + ' .pic--right');
    ...
    // Initialize draggable for each section
    initializeDraggable('.filter__container');   // Section 1
    initializeDraggable('.filter__container1');  // Section 2
    initializeDraggable('.filter__container2');  // Section 3
